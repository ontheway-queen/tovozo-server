...
class JobApplicationModel extends schema_1.default {
    ...
    getApplication(job_post_details_id) {
    ...
    getMyJobApplications(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.db("job_applications as ja")
                .withSchema(this.DBO_SCHEMA)
                .select("ja.id as job_application_id", "ja.status as job_application_status", "jpd.start_time", "jpd.end_time", "j.title as job_post_title", "j.job_seeker_pay", "org.id as organization_id", "org.name as organization_name", "org_p.file as organization_photo", "vwl.location_address", "vwl.city_name", "vwl.longitude", "vwl.latitude")
