...
exports.registrationHotelierTemplate = void 0;
const constants_1 = require("../miscellaneous/constants");
const registrationHotelierTemplate = (payload) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div style="max-width:450px; margin:20px auto; background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.1); border:1px solid #e7e9ec;">
    ...
    <div style="padding:20px;">
      ...
      <p style="margin:10px 0; font-size:14px; line-height:1.5;">
        Thank you for registering as a <strong>Hotelier</strong> with <strong>${constants_1.PROJECT_NAME}</strong>. We appreciate your interest in joining our platform.
      </p>
      <p style="margin:10px 0; font-size:14px; line-height:1.5;">
    ...
    <div style="background-color:#f1f5fa; text-align:center; padding:10px; font-size:12px; color:#666;">
      ...
      <p style="margin:5px 0;">Visit our website at <a href="${constants_1.HOTELIER_CLIENT_URL}" target="_blank" style="color:#0085D4; text-decoration:none;">${constants_1.HOTELIER_CLIENT_URL}</a>.</p>
...
exports.registrationHotelierTemplate = registrationHotelierTemplate;
