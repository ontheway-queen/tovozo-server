...
exports.documentVerificationSuccessTemplate = void 0;
const constants_1 = require("../miscellaneous/constants");
const documentVerificationSuccessTemplate = (name) => {
    return `
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 480px; background: #ffffff; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); border: 1px solid #e0e0e0; overflow: hidden;">
            ...
            <tr>
              <td align="center" style="background-color: #0491e2; padding: 25px 10px;">
                <img src="${constants_1.PROJECT_LOGO}" alt="${constants_1.PROJECT_NAME}" style="display: block; width: 90px; margin-bottom: 10px;" />
                <h2 style="color: #ffffff; font-size: 20px; font-weight: normal; margin: 0;">${constants_1.PROJECT_NAME}</h2>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding: 20px 30px;">
                ...
                <p style="font-size: 15px; color: #555555; line-height: 1.6; margin: 0 0 20px;">
                  ...
                  Your <strong>${constants_1.PROJECT_NAME}</strong> account is now fully active, and you can start applying for jobs right away.
                </p>
            ...
            <tr>
              <td align="center" style="padding: 15px 20px 25px;">
                <p style="font-size: 12px; color: #7c7b7b; line-height: 1.6; margin: 0;">
                  ...
                  <a href="mailto:support@${constants_1.PROJECT_NAME.toLowerCase()}.com" style="color: #0491e2; text-decoration: none;">support@${constants_1.PROJECT_NAME.toLowerCase()}.com</a>.
                  <br /><br />
...
exports.documentVerificationSuccessTemplate = documentVerificationSuccessTemplate;
