...
const commonModel_1 = __importDefault(
	require("../../../models/commonModel/commonModel")
);
...
class JobPostWorker {
	expireJobPostDetails(job) {
		return __awaiter(this, void 0, void 0, function* () {
			const { id } = job.data;
			return yield database_1.db.transaction((trx) =>
				__awaiter(this, void 0, void 0, function* () {
					const jobPostModel = new rootModel_1.default().jobPostModel(
						trx
					);
