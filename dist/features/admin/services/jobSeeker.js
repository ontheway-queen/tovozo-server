    ...
    updateJobSeeker(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (parsed.user.account_status === constants_1.USER_STATUS.ACTIVE) {
                    yield lib_1.default.sendEmailDefault({
                        email: existingUser.email,
                        emailSub: "Account Activation Successful – You Can Now Log In",
                        emailBody: (0, registrationVerificationCompletedTemplate_1.registrationVerificationCompletedTemplate)(existingUser.name),
                    });
