...
const adminNotificationService_1 = __importDefault(require("../services/adminNotificationService"));
class AdminNotificationController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new adminNotificationService_1.default();
