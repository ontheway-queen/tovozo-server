...
class MessageController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new messageService_1.default();
        ...
        this.getChatSessionForAdmin = this.asyncWrapper.wrap({ querySchema: joi_1.default.object().unknown(true) }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.services.getChatSessionForAdmin(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        this.getChatMessages = this.asyncWrapper.wrap({ querySchema: joi_1.default.object().unknown(true) }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.services.getChatMessages(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
        this.createChatMessage = this.asyncWrapper.wrap({ bodySchema: joi_1.default.object().unknown(true) }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.services.createChatMessage(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
    }
}
