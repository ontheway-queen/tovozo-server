...
const adminMessageService_1 = __importDefault(require("../services/adminMessageService"));
class AdminChatController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new adminMessageService_1.default();
...
exports.default = AdminChatController;
