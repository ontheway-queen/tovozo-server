...
const hotelierNotificationService_1 = __importDefault(require("../services/hotelierNotificationService"));
class HotelierNotificationController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new hotelierNotificationService_1.default();
...
exports.default = HotelierNotificationController;
