...
exports.HotelierChatController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const hotelierChat_service_1 = require("../services/hotelierChat.service");
const hotelierChat_validator_1 = __importDefault(require("../utils/validator/hotelierChat.validator"));
class HotelierChatController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new hotelierChat_service_1.HotelierChatService();
        this.validator = new hotelierChat_validator_1.default();
...
exports.HotelierChatController = HotelierChatController;
