...
const auth_jobSeeker_service_1 = __importDefault(require("../services/auth.jobSeeker.service"));
class JobSeekerAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new auth_jobSeeker_service_1.default();
        //register
        this.registration = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.registerJobSeekerValidator }, 
        // null,
...
exports.default = JobSeekerAuthController;
