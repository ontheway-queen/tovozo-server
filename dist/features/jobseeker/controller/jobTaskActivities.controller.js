...
class JobTaskActivitiesController extends abstract_controller_1.default {
    constructor() {
        ...
        this.createJobTaskActivity = this.asyncWrapper.wrap({ bodySchema: this.validator.createJobTaskActivity }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.createJobTaskActivities(req), { code } = _a, data = __rest(_a, ["code"]);
