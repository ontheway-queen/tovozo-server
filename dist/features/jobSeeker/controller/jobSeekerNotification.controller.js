...
const jobSeekerNotificationService_1 = __importDefault(require("../service/jobSeekerNotificationService"));
class JobSeekerNotificationController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new jobSeekerNotificationService_1.default();
...
exports.default = JobSeekerNotificationController;
